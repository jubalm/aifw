...
async function init(claudeCodeFlag = false) {
  ...
  try {
    ...
    if (platform === 'claude-code') {
      ...
      console.log('  2. Generate comprehensive project context:');
      console.log('     @aifw-delegator generate comprehensive project context');
      console.log('  3. Create specialized development agents:');
      console.log('     @aifw-delegator create specialized development agents');
    }
